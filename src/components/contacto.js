...
import ContactoNoFoto from './Img/ContactoNoFoto.png';
    ...
    render() {       
        ...
        return (
            <div className="container" style={TarjetaContacto}>
                ...
                <div className="card" >
                    <img src={ContactoNoFoto} className="card-img-top img" alt="ImagemContacto"/>
                    <div className="card-body">

                        <form onSubmit={this.onSubmit}>
                            <h5 className="card-title h5">Nome</h5>
                            ...
                            <h5 className="card-title h5">Telefone</h5>
                            <div className="form-group row input">
                            <input type="text"  
                            onChange={this.onChange} 
                            name ="numero" 
                            ...
                            {"  "}
                            <button className="btn btn-primary btnleth"
                                style={btnEliminar}
